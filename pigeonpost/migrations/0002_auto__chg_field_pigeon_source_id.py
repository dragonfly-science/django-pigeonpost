...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pigeon.source_id'
        db.alter_column('pigeonpost_pigeon', 'source_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Pigeon.source_id'
        raise RuntimeError("Cannot reverse this migration. 'Pigeon.source_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Pigeon.source_id'
        db.alter_column('pigeonpost_pigeon', 'source_id', self.gf('django.db.models.fields.PositiveIntegerField')())
